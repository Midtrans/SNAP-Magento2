...
namespace Icube\Snapinstmigs\Block\Widget;
...
class Redirect extends Template
{
    ...
    public function __construct(
        ...
        \Icube\Snapinstmigs\Model\Snapinstmigs $paymentConfig,
        array $data = []
    ) {
    ...
    public function getGateUrl(){
        ...
        $redirUrl = $baseUrl.'snapinstmigs/payment/redirect';
        return $redirUrl;
    }
    ...
    public function isVisible() {
        ...
        return ($code==\Icube\Snapinstmigs\Model\Snapinstmigs::SNAPINSTMIGS_PAYMENT_CODE);
    }
