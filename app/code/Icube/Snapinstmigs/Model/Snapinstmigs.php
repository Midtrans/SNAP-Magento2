<?php
namespace Icube\Snapinstmigs\Model;

use Magento\Quote\Api\Data\CartInterface;
use Magento\Payment\Model\Method\AbstractMethod;
use Icube\Snapinstmigs\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class Snapinstmigs extends \Magento\Payment\Model\Method\AbstractMethod
{
    const SNAPINSTMIGS_PAYMENT_CODE = 'snapinstmigs';
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $_formBlockType = 'Icube\Snapinstmigs\Block\Form\Snapinstmigs';
