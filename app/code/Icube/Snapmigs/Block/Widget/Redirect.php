...
namespace Icube\Snapmigs\Block\Widget;
...
class Redirect extends Template
{
    ...
    public function __construct(
        ...
        \Icube\Snapmigs\Model\Snapmigs $paymentConfig,
        array $data = []
    ) {
    ...
    public function getGateUrl(){
        ...
        $redirUrl = $baseUrl.'snapmigs/payment/redirect';
        return $redirUrl;
    }
    ...
    public function isVisible() {
        ...
        return ($code==\Icube\Snapmigs\Model\Snapmigs::SNAPMIGS_PAYMENT_CODE);
    }
