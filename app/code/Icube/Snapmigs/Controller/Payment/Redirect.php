<?php
namespace Icube\Snapmigs\Controller\Payment;
...
//        $is_enabled_mandiri = Mage::getStoreConfig('payment/snap/enable_installment_mandiri');
        $isProduction = $config->getValue('payment/snapmigs/is_production', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)=='1'?true:false;
        $vtConfig->setIsProduction($isProduction);

        $is3ds = $config->getValue('payment/snapmigs/is_3ds', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)=='1'?true:false;
...
//$config = new Veritrans_Config();
        $title = $config->getValue('payment/snapmigs/title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $serverKey = $config->getValue('payment/snapmigs/server_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
//        echo $title;exit();
        $oneClick = $config->getValue('payment/snapmigs/one_click', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $bank = $config->getValue('payment/snapmigs/bank', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $customExpiry = $config->getValue('payment/snapmigs/custom_expiry', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
