<?php
namespace Icube\Snapmigs\Model;

use Magento\Quote\Api\Data\CartInterface;
use Magento\Payment\Model\Method\AbstractMethod;
use Icube\Snapmigs\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class Snapmigs extends \Magento\Payment\Model\Method\AbstractMethod
{
    const SNAPMIGS_PAYMENT_CODE = 'snapmigs';
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $_formBlockType = 'Icube\Snapmigs\Block\Form\Snapmigs';
