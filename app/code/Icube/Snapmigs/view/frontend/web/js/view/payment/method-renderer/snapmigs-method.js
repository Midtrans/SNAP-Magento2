define(
    [
        ...
        'Icube_Snapmigs/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Icube_Snapmigs/payment/snapmigs'
            },
            redirectAfterPlaceOrder: false,
            /** Open VT-Snap */
            afterPlaceOrder: function () {
                var production = window.checkoutConfig.payment.snapmigs.production;
                var client_key = window.checkoutConfig.payment.snapmigs.clientkey;
                var merchant_id = window.checkoutConfig.payment.snapmigs.merchantid;
                var mixpanel_key = window.checkoutConfig.payment.snapmigs.mixpanelkey;
