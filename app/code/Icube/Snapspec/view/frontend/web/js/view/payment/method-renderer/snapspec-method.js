define(
    [
        ...
        'Icube_Snapspec/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'Icube_Snapspec/payment/snapspec'
            },
            ...
            afterPlaceOrder: function () {
                ...
                $.ajax({
                    type: 'post',
                    url: url.build('snapspec/payment/redirect'),
                    cache: false,
                                ...
                                try{
                                    snap.pay(token, 
                                    {
                                        ...
                                        onSuccess: function(result){
                                            trackResult(data, merchant_id, 'specific_payment', 'success', result);
                                        ...
                                        onPending: function(result){
                                            trackResult(data, merchant_id, 'specific_payment', 'pending', result);
                                            messageList.addSuccessMessage({
                                                message: result.status_message
                                            });
                                            window.location.replace(url.build('checkout/onepage/success'));
                                        ...
                                        onError: function(result){
                                            trackResult(data, merchant_id , 'specific_payment', 'error', result);
                                        ...
                                        onClose: function(){
                                            ...
                                            trackResult(data, merchant_id, 'specific_payment', 'close');
                                            $.ajax({
