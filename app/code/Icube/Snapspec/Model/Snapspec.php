<?php
namespace Icube\Snapspec\Model;

use Magento\Quote\Api\Data\CartInterface;
use Magento\Payment\Model\Method\AbstractMethod;
use Icube\Snap\specModel\Config\Source\Order\Status\Paymentreview;
...
class Snapspec extends \Magento\Payment\Model\Method\AbstractMethod
{
     ...
     * @var string
     */
    protected $_formBlockType = 'Icube\Snapspec\Block\Form\Snapspec';
