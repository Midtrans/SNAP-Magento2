<?php
namespace Icube\Snapspec\Controller\Payment;
...
class Redirect extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $title = $config->getValue('payment/snapspec/title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $isProduction = $config->getValue('payment/snapspec/is_production', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)=='1'?true:false;
        $is3ds = $config->getValue('payment/snapspec/is_3ds', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)=='1'?true:false;
        $serverKey = $config->getValue('payment/snapspec/server_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $oneClick = $config->getValue('payment/snapspec/one_click', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $customExpiry = $config->getValue('payment/snapspec/custom_expiry', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $enablePayment = $config->getValue('payment/snapspec/enable_payment', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
