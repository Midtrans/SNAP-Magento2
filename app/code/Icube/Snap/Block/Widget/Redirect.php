...
namespace Icube\Snap\Block\Widget;
...
class Redirect extends Template
{
    ...
    public function __construct(
        ...
        \Icube\Snap\Model\Snap $paymentConfig,
        array $data = []
    ) {
    ...
    public function getGateUrl(){
        ...
        $redirUrl = $baseUrl.'snap/payment/redirect';
        return $redirUrl;
    }
    ...
    public function isVisible() {
        ...
        return ($code==\Icube\Snap\Model\Snap::SNAP_PAYMENT_CODE);
    }
