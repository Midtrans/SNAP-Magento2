<?php
namespace Icube\Snapio\Model;

use Magento\Quote\Api\Data\CartInterface;
use Magento\Payment\Model\Method\AbstractMethod;
use Icube\Snapio\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class Snapio extends \Magento\Payment\Model\Method\AbstractMethod
{
    const SNAPIO_PAYMENT_CODE = 'snapio';
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $_formBlockType = 'Icube\Snapio\Block\Form\Snapio';
